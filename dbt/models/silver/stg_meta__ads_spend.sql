-- Daily Meta ads spend, unioned across all three loaded ad accounts
-- (Revitalash, iS Clinical, Deese PRO). Each brand's raw ADS_INSIGHTS
-- table is aggregated to one row per day, then we union and add
...
{% set brands = ['isclinical', 'deese_pro', 'revitalash'] %}
